...
class P_net_test():
    ...
    def test(self, model_file):
        ...
        for im_file, bboxes in test_dir[:]:
            ...
            R_net_train.append([im_file, bboxes, res])
        joblib.dump(R_net_train, 'R_net_train_wider_1.pkl')
...
if __name__ == "__main__":
    ...
    model_file = '/home/zhai/PycharmProjects/Demo35/MTCNN/train/models/P_net_45000_1.pth'
